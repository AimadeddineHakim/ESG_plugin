# musk-v-altman-fraud-case

=== The OpenAI Fraud Case Reveals a Broken System. Here's the Fix Nobody's Talking About. (https://www.techbuzz.ai/articles/the-open-ai-fraud-case-reveals-a-broken-system-here-s-the-fix-nobody-s-talking-about) [independently scraped] ===
...
- 
2015: Musk donates $38M to OpenAI, a nonprofit promising to develop AI for humanity's benefit
- 
2017: Brockman writes "it was a lie" in his diary about the nonprofit commitment
- 
2019: OpenAI creates a for-profit subsidiary and takes $1B from Microsoft
- 
2025: That subsidiary is now worth $500 billion
- 
Today: The nonprofit Musk funded controls less than a third of the company
...
- 
Stay small and principled — limited impact, constant fundraising stress
- 
Grow and drift — take corporate money, watch the mission fade
...
What does this mean?
- 
Trading fees flow directly to verified nonprofits
- 
Token holders vote on which organizations get funding
- 
Everything happens on-chain with full transparency
- 
Revenue qualifies for tax-exempt treatment
...
- 
25% to hunger relief partners (verified 501(c)(3) organizations)
- 
25% to EAT DUNA (operations and ecosystem growth governed by token holders)
- 
25% to WYDE operations (keeping the liquidity and fees growing)
- 
25% to protocol costs (technical infrastructure)
...
- 
Launched a governance token — capital raised without selling equity
- 
Let trading generate ongoing funding — sustainable without donation cycles
- 
Given token holders voting rights — distributed governance, not board politics
- 
Written the mission into the legal structure — not just marketing materials
...
Learn more: wyde.org | @wydeorg | hello@wyde.org
[DISCLOSURE]
...
=== Musk's Failed OpenAI Lawsuit Underscores xAI's Struggles (https://time.com/article/2026/05/19/elon-musk-openai-trial-xai-jury-verdict/) [report body - scrape unavailable] ===

On Monday, an Oakland jury took under two hours to unanimously reach a verdict dismissing Elon Musk's lawsuit against Sam Altman and OpenAI. Throughout the trial Musk had portrayed it as the good fight to prevent Altman from "stealing" OpenAI, which was founded as a nonprofit. Others framed it as a more cynical effort. "It's too late now to gin up something to harm a competitor," said OpenAI's lead lawyer, William Savitt, during his opening arguments.
...
The jury's decision that Musk waited too long to sue, exceeding a three-year statute of limitations, is just the latest blow to Musk and xAI. Musk's sworn testimony on April 30 dealt another blow to his AI company's credibility -- the xAI CEO seemed to admit on the stand that xAI "partly" trains its models on the outputs of OpenAI's models.

No allegations of fraud were substantively adjudicated on the merits; the case was dismissed on procedural (statute-of-limitations) grounds, leaving the underlying nonprofit-mission dispute unresolved as a matter of law.

---

=== Follow-up research ===

Question: Is the Musk v. Altman/OpenAI case fully concluded after the May 2026 jury verdict, or is there a pending appeal that would keep it active?

Finding: Musk's legal team announced it will appeal the verdict to the U.S. Court of Appeals for the Ninth Circuit, dismissing the statute-of-limitations ruling as a "technicality"; the appellate process is expected to run into 2027. The trial-court phase is resolved (jury verdict for OpenAI/Altman), but the case as a whole remains active on appeal. Sources: https://www.cnbc.com/2026/05/18/musk-altman-openai-trial-verdict.html ; https://news.bloomberglaw.com/litigation/musk-v-altman-fight-heads-to-appeal-with-core-claims-untested